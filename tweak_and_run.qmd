---
title: 'How to Create a Run with tweak parametrs in DolphinNext?'
execute:
  echo: false
  warning: false
  message: false
...
![](https://ajeuwbhvhr.cloudimg.io/colony-recorder.s3.amazonaws.com/files/2023-08-13/a11ce0db-69a5-4987-8dac-0e5a4162b580/ascreenshot.jpeg?tl_px=200,0&br_px=1920,902&force_format=png&width=560.0&wat_scale=50&wat=1&wat_opacity=0.7&wat_gravity=northwest&wat_url=https://colony-recorder.s3.us-west-1.amazonaws.com/images/watermarks/FB923C_standard.png&wat_pad=369,174)

**7. Enter run name and click on "Save run" button**
...
**10. Enter the new parametrs for this module,  the parametrs that appear is the default in the module (not in the pipeline)**
...
**12. Run the pipeline with the tweak parametrs**
